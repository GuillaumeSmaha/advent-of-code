...
func (m *Map3D) ExpandBorder(caseSearch int, caseSet int, alignSize bool, keepCubic bool) {
	...
	m.ForeachXYApply(func(m *Map3D, x, y, z, v int) {
		if v == caseSearch {
			if x == minX {
	...
	m.ForeachXYApply(func(m *Map3D, x, y, z, _ int) {
...
func (m *Map3D) ForeachXYApply(apply func(m *Map3D, x, y, z, v int)) {
	minX, minY, minZ, maxX, maxY, maxZ := m.Bounds()
